...
//                                                                              //
// USAGE: On init call: GuiLoadStylePumpkin();                                   //
//                                                                              //
...
#define PUMPKIN_STYLE_PROPS_COUNT  19

// Custom style name: Pumpkin
static const GuiStyleProp pumpkinStyleProps[PUMPKIN_STYLE_PROPS_COUNT] = {
    { 0, 0, 0xcd683d00 },    // DEFAULT_BORDER_COLOR_NORMAL
    { 3, 0, 0x19141aff },    // TOGGLE_BORDER_COLOR_NORMAL
    { 0, 1, 0x1b0c1cff },    // DEFAULT_BASE_COLOR_NORMAL
    { 3, 1, 0x19141aff },    // TOGGLE_BASE_COLOR_NORMAL
    { 0, 2, 0xc28173ff },    // DEFAULT_TEXT_COLOR_NORMAL
    { 0, 3, 0xf68181ff },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, 0x432641ff },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, 0xfdcbb0ff },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, 0xf68181ff },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, 0x7a3045ff },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, 0xfdcbb0ff },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, 0x753c54ff },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, 0x1b0c1cff },    // DEFAULT_BASE_COLOR_DISABLED 
    { 0, 11, 0x753c54ff },    // DEFAULT_TEXT_COLOR_DISABLED 
    { 0, 16, 0x0000000e },    // DEFAULT_TEXT_SIZE 
    { 0, 17, 0x00000000 },    // DEFAULT_TEXT_SPACING 
    { 0, 18, 0x84564eff },    // DEFAULT_LINE_COLOR 
    { 0, 19, 0x19141aff },    // DEFAULT_BACKGROUND_COLOR
    { 0, 20, 0x00000015 },    // DEFAULT_TEXT_LINE_SPACING
};

// WARNING: This style uses a custom font: "Kyrou 7 Wide.ttf" (size: 14, spacing: 0)

#define PUMPKIN_STYLE_FONT_ATLAS_COMP_SIZE 2286

// Font atlas image pixels data: DEFLATE compressed
static unsigned char pumpkinFontData[PUMPKIN_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle pumpkinFontRecs[189] = {
        { 4, 4, 4 , 14 },
        { 16, 4, 1 , 8 },
        { 25, 4, 4 , 3 },
        { 37, 4, 8 , 8 },
...
static const GlyphInfo pumpkinFontGlyphs[189] = {
        { 32, 0, 11, 4, { 0 }},
        { 33, 0, 3, 2, { 0 }},
        { 34, 0, 3, 4, { 0 }},
        { 35, 0, 3, 8, { 0 }},
...
// Style loading function: Pumpkin
static void GuiLoadStylePumpkin(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < PUMPKIN_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(pumpkinStyleProps[i].controlId, pumpkinStyleProps[i].propertyId, pumpkinStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int pumpkinFontDataSize = 0;
    unsigned char *data = DecompressData(pumpkinFontData, PUMPKIN_STYLE_FONT_ATLAS_COMP_SIZE, &pumpkinFontDataSize);
    ...
    memcpy(font.recs, pumpkinFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, pumpkinFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
